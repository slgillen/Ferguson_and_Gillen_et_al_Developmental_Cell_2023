...
def mapEnhancerToGene(annotFile,enhancerFile,transcribedFile='',uniqueGenes=True,searchWindow =100000,noFormatTable = False):
    ...
    if noFormatTable:
        ...
        #first by enhancer
        #changed 0:9
        enhancerToGeneTable = [enhancerTable[0][0:13]+['OVERLAP_GENES','PROXIMAL_GENES','CLOSEST_GENE'] + enhancerTable[5][-2:]]
